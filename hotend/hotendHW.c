...
void initHotendHW(void)
{
    ...
    HWREG(TIMER_BASE_HOTEND + TIMER_O_TBILR) = HOTEND_D10_PERIOD;    //720895
...
//    HWREG(TIMER_BASE_HOTEND + TIMER_O_CTL) |= TIMER_CTL_TBSTALL;
    ...
    HWREG(TIMER_BASE_HOTEND  + TIMER_O_TBMATCHR) = HOTEND_D10_PERIOD-5;
...
void setTIMER_HOTEND(uint32_t value)
{
    ...
    HWREG(TIMER_BASE_HOTEND  + TIMER_O_TBMATCHR) = HOTEND_D10_PERIOD-value;
}
