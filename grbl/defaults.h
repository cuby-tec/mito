...
#define SCRWE_PITCH_BASE			6	// mm
#define ENCODER_STEPS				60 //  с учётом трансформации
// Grbl generic default settings. Should work across different machines.
/**
 * Вычисляется как <шаг_винта>*<передаточное число энкодера>
 * <передаточное число энкодера> = 6
 * <шаг_винта> = 6
 * <разрешаюшая способность энкодера> = 360,
 * обратное значение.
 */
  #define DEFAULT_X_STEPS_PER_MM 	ENCODER_STEPS/SCRWE_PITCH_BASE//10 // 250.0


#define SCRWE_PITCH					4// mm
#define MOTOR_STEPS_PER_REV			200
/**
 * Вычисляется как <шаг_винта> / <шагов_за_оборот> / <передаточное_число>
 * <шаг_винта> = 4
 * <шагов_за_оборот> = 200
 * <передаточное_число> = 2,5,
 * обратное значение.
 * */
//MOTOR_STEPS_PER_REV/SCRWE_PITCH // 250.0
  #define DEFAULT_Y_STEPS_PER_MM 	 DEFAULT_STEPMOTOR_STEPS/SCRWE_PITCH

  #define DEFAULT_Z_STEPS_PER_MM 	125 // 250.0
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
/**
 * Приводит к длине проекции отрезка на ось X - 2шага, что приводит к натеканию
 * ошибки по оси X.
 */
  #define DEFAULT_MM_PER_ARC_SEGMENT 	2//0.5	// 0.1
  #define DEFAULT_RAPID_FEEDRATE 		500.0 // mm/min
  #define DEFAULT_FEEDRATE 				250.0
  #define DEFAULT_ACCELERATION 			35//17//35//70//140//280 //(10.0*60*60) // 10 mm/min^2
  ...
  #define MAX_NOMINAL_SPEED					7.6
  #define DEFAULT_SEEK_SPEED				12.5e-3//0.4/60 // m/sec 0.4 // m/min
#endif
