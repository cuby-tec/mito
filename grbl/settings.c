...
#ifdef KTF7
   settings.mm_per_encoder = MM_PER_ENCODER;
   settings.stepmotor_steps = DEFAULT_STEPMOTOR_STEPS;
   settings.rad_acceleration = DEFAULT_RADACCELERATION;
   settings.initial_rate = INITIAL_RATE;
   settings.fcnt = DEFAULT_COUNTERR_FREWUENCY;
   settings.max_nominal_speed = MAX_NOMINAL_SPEED;
   settings.seekSpeed = DEFAULT_SEEK_SPEED;
